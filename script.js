...
function Race100M(score, LongJump){
    setTimeout(() => {
        ...
        const sortArr = Object.keys(obj).sort((a, b) => obj[a] - obj[b]);
        let newObj = {};
        newObj[sortArr[0]] = 50;
        newObj[sortArr[1]] = 25;
        console.log("Winner of 100M race is " + sortArr[0]);
...
function AwardCeremony(score){
    ...
    let sortArr = Object.keys(score).sort((a, b) => score[a] - score[b]);
    let n = sortArr.length;
    
    console.log(`${sortArr[n-1]} Came First with ${score[sortArr[n-1]]} points`);
    console.log(`${sortArr[n-2]} Came Second with ${score[sortArr[n-2]]} points`);
    console.log(`${sortArr[n-3]} Came Third with ${score[sortArr[n-3]]} points`);
    console.log(`${sortArr[n-4]} Came Fourth with ${score[sortArr[n-4]]} points`);
}
